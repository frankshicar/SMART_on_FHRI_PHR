<template>
  <div>
    ...
    <div class="tab-bar">
      ...
      <nuxt-link to="/medicationRequest_view" :class="{ active: activeTab === 'medicationRequest' }" @click.native="setActive('medicationRequest')">個人資訊</nuxt-link>
    </div>
  </div>
</template>
...
export default {
  setup() {
    ...
    const makeAppointment = ref('預約取藥');
    const viewAppointment = ref('查看預約');
